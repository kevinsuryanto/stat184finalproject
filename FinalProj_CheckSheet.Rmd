...
(B) .Rmd Line numbers for inspecting data intake:69 & 70
...
(A) .Rmd Line number(s) for general data wrangling: 96 & 101


(B) .Rmd Line number(s) for a join operation: 77


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):


(D) .Rmd Line number(s) for use of regular expressions: 114 & 121


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 116 & 123
...
(A) .Rmd Line number(s) for use of mulitple different geoms:127 & 131  

(B) .Rmd Line number(s) for use of multiple aesthetics:131  

(C) .Rmd Line number(s) for use of layered graphics:131
